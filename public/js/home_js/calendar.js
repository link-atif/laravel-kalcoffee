...
function n_createCalendar(layout, n_firstDay, n_numbDays, n_monthNum, n_yearNum) { 
	...
	n_calendarString += '<tr>';
	if (layout == 'full') {
		n_calendarString += '<td class=\"calendar-btn\"><span onClick=\"n_changedate(\'prevyr\', \'full\')\">Â« <span class="btn-change-date">' + n_prev_year + '<\/span><\/span><\/td>';
		n_calendarString += '<td class=\"calendar-btn\"><span onClick=\"n_changedate(\'prevmo\', \'full\')\">Â« <span class="btn-change-date">' + n_prev_month + '<\/span><\/span><\/td>';
		...
		n_calendarString += '<td class=\"calendar-btn\"><span onClick=\"n_changedate(\'nextmo\', \'full\')\"><span class="btn-change-date">' + n_next_month + '<\/span> Â»<\/span><\/td>';
		n_calendarString += '<td class=\"calendar-btn\"><span onClick=\"n_changedate(\'nextyr\', \'full\')\"><span class="btn-change-date">' + n_next_year + '<\/span> Â»<\/span><\/td>';
	} else {
		n_calendarString += '<td class=\"calendar-btn\"><span onClick=\"n_changedate(\'prevyr\', \'compact\')\">Â«<\/span><\/td>';
		n_calendarString += '<td class=\"calendar-btn\"><span onClick=\"n_changedate(\'prevmo\', \'compact\')\">Â«<\/span><\/td>';
		n_calendarString += '<td class=\"calendar-title\" colspan=\"3\"><span>' + n_wordMonth[n_monthNum - 1] + '&nbsp;&nbsp;' + n_yearNum + '<\/span><\/td>';
		n_calendarString += '<td class=\"calendar-btn\"><span onClick=\"n_changedate(\'nextmo\', \'compact\')\">Â»<\/span><\/td>';
		n_calendarString += '<td class=\"calendar-btn\"><span onClick=\"n_changedate(\'nextyr\', \'compact\')\">Â»<\/span><\/td>';
	}
	n_calendarString += '<\/tr>';
