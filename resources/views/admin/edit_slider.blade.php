...
<div role="main">
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                <form method="post" name="frm" action="{{ url('/admin/edit-slider/'.$sliderDetails->id) }}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate> {{ csrf_field() }}
                    @if($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <img width="100px" height="100px" src="{{ asset('/images/admin/slider/'.$sliderDetails->image) }}">
                        </div>
                    </div>
                    @endif
                    <div class="form-group">
