    ...
    <main>
      ...
      <div id="details" class="clearfix">
        <div id="client">
          ...
          <div class="to">Invoice #: <b>{{$req->order_id}}</b> </div>
          <div class="to">Date: {{ $req->updated_at }}</div>
          <div class="to">Name: {{ $req->name }}</div>
          <div class="to">Address: {{ $req->address_1 }}</div>
        </div>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tfoot >
          <tr>
          <!--   <td colspan="2"></td> -->
            <td colspan="3" >SUBTOTAL:&nbsp;&nbsp;&nbsp;<b >{{ $req->sub_total }}</td>
            <td></td>
          </tr>
          <tr>
            <!-- <td colspan="2"></td> -->
            <td colspan="3">TAX:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>2%</b></td>
            <td></td>
          </tr>
          <tr>
            <!-- <td colspan="2"></td> -->
            <td colspan="3">GRAND TOTAL:&nbsp;&nbsp;&nbsp;<b>{{ $req->sub_total+(0.2*$req->sub_total) }}</b></td>
            <td></td>
          </tr>
        </tfoot>
      </table>
      <div id="notices">
        <div>Please use the following communication for your payment : Invoice # <b>{{$req->order_id}}</b></div>
