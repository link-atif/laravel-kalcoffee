...
class SliderImages extends Controller{
    	...
    	if($request->isMethod('post')){
    		...
    		if($request->hasFile('image')){
    			...
    			if($image_tmp->isValid()){
    				...
    				$image_path = 'images/admin/slider/'.$filename;
    				// Resize Images
            ...
            return redirect('admin/view-slider')->with('flash_message_success','Slider Image has been added successfully!');
    	}
    ...
    public function editSlider(Request $request, $id = null){
        if($request->isMethod('post')){
            ...
            return redirect('/admin/view-slider')->with('flash_message_success','Slider updated Successfully!');
        }
