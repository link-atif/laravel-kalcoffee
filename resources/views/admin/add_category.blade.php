...
@section('content')
    <div role="main">
      <div class="x_content content">
        ...
        <div class="x_content">
          <div class="x_panel">
            <form method="post" name="frm" action="{{ url('/admin/add-category') }}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>{{ csrf_field() }}
              @if($errors->any())
              ...
              <div class="item form-group">
                  ...
                  <div class="col-md-7 col-sm-7 col-xs-12">
                      <input type="text" name="category_name" required="required" class="form-control col-md-7 col-xs-12" value="{{ old('category_name') }}" />
                  </div>
              </div>
              <div class="item form-group">
